...
public class LengthTest {
    ...
    public void should_1_inch_equals_1_inch() {
        Length result = new Length(1, Units.INCH).as(Units.INCH);
    ...
    public void should_2_feet_equals_2_feet() {
        Length result = new Length(2, Units.FOOT).as(Units.FOOT);

        assertThat(result.getValue(), is(2.0));
        assertThat(result.getUnit(), is(Units.FOOT));
    }

    @Test
    public void should_3_yards_equals_3_yards() {
        Length result = new Length(3, Units.YARD).as(Units.YARD);
    ...
    public void should_1_foot_equals_12_inches() {
        Length result = new Length(1, Units.FOOT).as(Units.INCH);
    ...
    public void should_1_yard_equals_3_feet() {
        Length result = new Length(1, Units.YARD).as(Units.FOOT);
    ...
    public void should_1_yard_equals_36_inches() {
        Length result = new Length(1, Units.YARD).as(Units.INCH);
    ...
    public void should_2_yards_equals_72_inches() {
        Length result = new Length(2, Units.YARD).as(Units.INCH);
    ...
    public void should_12_inches_equals_1_foot() {
        Length result = new Length(12, Units.INCH).as(Units.FOOT);
    ...
    public void should_3_foot_equals_1_yard() {
        Length result = new Length(3, Units.FOOT).as(Units.YARD);
    ...
    public void should_36_inches_equals_1_yard() {
        Length result = new Length(36, Units.INCH).as(Units.YARD);
    ...
    public void should_18_inches_equals_half_yard() {
        Length result = new Length(18, Units.INCH).as(Units.YARD);
