...
public class LengthTest {
    ...
    public void should_2_feet_equals_2_feet() {
        Length result = new Length(2, Units.F).as(Units.F);
    ...
    public void should_1_foot_equals_12_inches() {
        Length result = new Length(1, Units.F).as(Units.INCH);
    ...
    public void should_1_yard_equals_3_feet() {
        Length result = new Length(1, Units.YARD).as(Units.F);
    ...
    public void should_12_inches_equals_1_foot() {
        Length result = new Length(12, Units.INCH).as(Units.F);
    ...
    public void should_3_foot_equals_1_yard() {
        Length result = new Length(3, Units.F).as(Units.YARD);
